...
describe('stack configuration', () => {
  ...
  describe('property management', () => {
    ...
    beforeAll(() => {
      ...
      names = {
        ALIAS_RECORD: 'stackIdARecord',
        BUCKET: 'stackIdBucket',
        CACHE_POLICY: 'stackIdCachePolicy',
        DEPLOYMENT: 'stackIdDeployment',
        DISTRIBUTION: 'stackIdDistribution',
        STACK: 'stackIdStack',
        STACK_ID: 'stackId',
        VIEWER_REQUEST_HANDLER: 'stackIdViewerRequestHandler',
        DOMAINS: 'domains',
        HOST: 'host',
